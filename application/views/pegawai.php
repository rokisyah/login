							...
							<table class="table table-hover" id="example">
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td> <?php echo "<img src='http://localhost:8080/codeigniter_alpha23/assets/uploads/$key->foto' height='75px' width='50px'>" ?></td>
										...
										<!-- <td><?php echo $key->foto ?></td> -->
										 <td>
											...
											<a href="<?php echo site_url('pegawai/update/').$key->id ?>" type="button" class="btn btn-primary">Edit</a>
											<a href="<?php echo site_url('pegawai/delete/').$key->id?>" onclick="return confirm('Yakin Menghapus Data?')" type="button" class="btn btn-danger">Hapus</a>
										</td>
									</tr>
								<?php } ?>
								<!-- <tr>
