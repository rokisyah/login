				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php echo form_open_multipart('pegawai/update/'.$this->uri->segment(3)); ?>
								...
								<div class="form-group">
									...
									<label>Foto</label>
									<input type="file" class="form-control" id="userfile" name="userfile" size="20" value="<?php echo $pegawai[0]->foto ?>" />
								...
								<a href="<?php echo site_url('pegawai') ?>"> <button type="button" class="btn btn-info">Cancel</button></a>
					<?php echo form_close(); ?>
					</div>
